...
python ./src/main.py --model_name BPRMF --emb_size 64 --lr 1e-3 --l2 0 --loss_n BPR --dataset MINDCTR --path ../data/ --metric NDCG,HR --topk 1,2,3,5,10 --main_metric NDCG@2 --model_mode Impression
...
python ./src/main.py --model_name GRU4Rec --hidden_size 64 --history_max 20 --emb_size 64 --lr 2e-3 --l2 0 --loss_n BPR --dataset MINDCTR --metric NDCG,HR --topk 1,2,3,5,10 --main_metric NDCG@2 --model_mode Impression
